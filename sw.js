// Fear & Loathing Trail v17 — Service Worker
const CACHE = 'flt-v17-cache-v1';
...
self.addEventListener('fetch', e => {
  ...
  if (e.request.url.includes('peerjs.com') || e.request.url.includes('unpkg.com') || e.request.url.includes('jsdelivr.net')) return;
